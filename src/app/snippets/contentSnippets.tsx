    ...
    <div className="overflow-hidden rounded-lg border border-gray-700 bg-[#111827] shadow">
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-2 p-2">
        {list.map((item) => (
          ...
          >
            <div className="text-lg font-semibold text-gray-100 mb-2 flex items-center cursor-pointer" onClick={() => handleShowDetail(item.id)}>
              <svg
                width="16"
                height="16"
                fill="none"
            ...
            <div className="mb-2 cursor-pointer text-[white]" onClick={() => handleShowDetail(item.id)}>
              {item.title}
            </div>
            <SyntaxHighlighter
